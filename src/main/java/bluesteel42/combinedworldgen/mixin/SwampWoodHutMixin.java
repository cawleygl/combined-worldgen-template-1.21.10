...
public class SwampWoodHutMixin extends ShiftableStructurePiece {
	 ...
	 * @author BlueSteel42
	 * @reason Changes Swamp Hut generation to use Willow and Dogwood Wood
	 */
	@Overwrite
	public void generate(StructureWorldAccess world,
		...
		if (this.adjustToAverageHeight(world, chunkBox, 0)) {
			this.fillWithOutline(world, chunkBox, 1, 1, 1, 5, 1, 7, WillowWoodModBlocks.MOD_PLANKS.getDefaultState(), WillowWoodModBlocks.MOD_PLANKS.getDefaultState(), false);
			this.fillWithOutline(world, chunkBox, 2, 5, 3, 4, 5, 6, WillowWoodModBlocks.MOD_PLANKS.getDefaultState(), WillowWoodModBlocks.MOD_PLANKS.getDefaultState(), false);
			this.fillWithOutline(world, chunkBox, 2, 1, 0, 4, 1, 0, WillowWoodModBlocks.MOD_PLANKS.getDefaultState(), WillowWoodModBlocks.MOD_PLANKS.getDefaultState(), false);
			this.fillWithOutline(world, chunkBox, 2, 2, 2, 4, 4, 2, WillowWoodModBlocks.MOD_PLANKS.getDefaultState(), WillowWoodModBlocks.MOD_PLANKS.getDefaultState(), false);
			this.fillWithOutline(world, chunkBox, 1, 2, 3, 1, 4, 6, WillowWoodModBlocks.MOD_PLANKS.getDefaultState(), WillowWoodModBlocks.MOD_PLANKS.getDefaultState(), false);
			this.fillWithOutline(world, chunkBox, 5, 2, 3, 5, 4, 6, WillowWoodModBlocks.MOD_PLANKS.getDefaultState(), WillowWoodModBlocks.MOD_PLANKS.getDefaultState(), false);
			this.fillWithOutline(world, chunkBox, 2, 2, 7, 4, 4, 7, WillowWoodModBlocks.MOD_PLANKS.getDefaultState(), WillowWoodModBlocks.MOD_PLANKS.getDefaultState(), false);
			this.fillWithOutline(world, chunkBox, 1, 0, 2, 1, 4, 2, DogwoodWoodModBlocks.STRIPPED_MOD_LOG.getDefaultState(), DogwoodWoodModBlocks.STRIPPED_MOD_LOG.getDefaultState(), false);
			this.fillWithOutline(world, chunkBox, 5, 0, 2, 5, 4, 2, DogwoodWoodModBlocks.STRIPPED_MOD_LOG.getDefaultState(), DogwoodWoodModBlocks.STRIPPED_MOD_LOG.getDefaultState(), false);
			this.fillWithOutline(world, chunkBox, 1, 0, 7, 1, 4, 7, DogwoodWoodModBlocks.STRIPPED_MOD_LOG.getDefaultState(), DogwoodWoodModBlocks.STRIPPED_MOD_LOG.getDefaultState(), false);
			this.fillWithOutline(world, chunkBox, 5, 0, 7, 5, 4, 7, DogwoodWoodModBlocks.STRIPPED_MOD_LOG.getDefaultState(), DogwoodWoodModBlocks.STRIPPED_MOD_LOG.getDefaultState(), false);
			...
			int pot = random.nextInt(3);
			if (pot == 0) {
				this.addBlock(world, Blocks.POTTED_BLUE_ORCHID.getDefaultState(), 1, 3, 5, chunkBox);
			} else if (pot == 1) {
				this.addBlock(world, Blocks.POTTED_BROWN_MUSHROOM.getDefaultState(), 1, 3, 5, chunkBox);
			} else {
			...
			BlockState blockState = WillowWoodModBlocks.MOD_STAIRS.getDefaultState().with(StairsBlock.FACING, Direction.NORTH);
			BlockState blockState2 = WillowWoodModBlocks.MOD_STAIRS.getDefaultState().with(StairsBlock.FACING, Direction.EAST);
			BlockState blockState3 = WillowWoodModBlocks.MOD_STAIRS.getDefaultState().with(StairsBlock.FACING, Direction.WEST);
			BlockState blockState4 = WillowWoodModBlocks.MOD_STAIRS.getDefaultState().with(StairsBlock.FACING, Direction.SOUTH);
			...
			this.addBlock(world, WillowWoodModBlocks.MOD_FENCE.getDefaultState().with(FenceBlock.NORTH, true), 1, 2, 1, chunkBox);
			this.addBlock(world, WillowWoodModBlocks.MOD_FENCE.getDefaultState().with(FenceBlock.NORTH, true), 5, 2, 1, chunkBox);
			this.addBlock(world, WillowWoodModBlocks.MOD_FENCE.getDefaultState().with(FenceBlock.EAST, true).with(FenceBlock.WEST, true), 2, 3, 2, chunkBox);
			this.addBlock(world, WillowWoodModBlocks.MOD_FENCE.getDefaultState().with(FenceBlock.EAST, true).with(FenceBlock.WEST, true), 3, 3, 7, chunkBox);
			...
			for (int i = 2; i <= 7; i += 5) {
				for (int j = 1; j <= 5; j += 4) {
					this.fillDownwards(world, WillowWoodModBlocks.STRIPPED_MOD_LOG.getDefaultState(), j, -1, i, chunkBox);
				}
			}
