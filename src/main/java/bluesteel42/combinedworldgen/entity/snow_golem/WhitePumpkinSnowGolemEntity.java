...
public class WhitePumpkinSnowGolemEntity extends GolemEntity implements Shearable, RangedAttackMob {
    private static final TrackedData<Byte> SNOW_GOLEM_FLAGS = DataTracker.registerData(WhitePumpkinSnowGolemEntity.class, TrackedDataHandlerRegistry.BYTE);
    private static final byte HAS_PUMPKIN_FLAG = 16;
    private static final boolean DEFAULT_HAS_PUMPKIN = true;

    public WhitePumpkinSnowGolemEntity(EntityType<? extends WhitePumpkinSnowGolemEntity> entityType, World world) {
    ...
    public void sheared(ServerWorld world, SoundCategory shearedSoundCategory, ItemStack shears) {
        ...
        this.forEachShearedItem(
                world, ModLootTables.WHITE_PUMPKIN_SNOW_GOLEM_SHEARING, shears, (serverWorld, itemStack) -> this.dropStack(serverWorld, itemStack, this.getStandingEyeHeight())
        );
    }
