...
public class GreenPumpkinSnowGolemEntity extends GolemEntity implements Shearable, RangedAttackMob {
    private static final TrackedData<Byte> SNOW_GOLEM_FLAGS = DataTracker.registerData(GreenPumpkinSnowGolemEntity.class, TrackedDataHandlerRegistry.BYTE);
    private static final byte HAS_PUMPKIN_FLAG = 16;
    private static final boolean DEFAULT_HAS_PUMPKIN = true;

    public GreenPumpkinSnowGolemEntity(EntityType<? extends GreenPumpkinSnowGolemEntity> entityType, World world) {
    ...
    public void sheared(ServerWorld world, SoundCategory shearedSoundCategory, ItemStack shears) {
        ...
        this.forEachShearedItem(
                world, ModLootTables.GREEN_PUMPKIN_SNOW_GOLEM_SHEARING, shears, (serverWorld, itemStack) -> this.dropStack(serverWorld, itemStack, this.getStandingEyeHeight())
        );
    }
