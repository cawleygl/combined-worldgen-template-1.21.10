...
public class ChollaWoodInitializer {
    ...
    public static final BlockSetType MOD_BLOCK_SET_TYPE = BlockSetTypeBuilder.copyOf(BlockSetType.BAMBOO).register(Identifier.of(CombinedWorldgen.MOD_ID, ChollaWoodInitializer.MOD_WOOD_NAME));
    public static final WoodType MOD_WOOD_TYPE = WoodTypeBuilder.copyOf(WoodType.BAMBOO).register(Identifier.of(CombinedWorldgen.MOD_ID, ChollaWoodInitializer.MOD_WOOD_NAME), ChollaWoodInitializer.MOD_BLOCK_SET_TYPE);
