...
public class BaobabWoodModRegistries {
    ...
    public static void registerFlammables() {
        ...
        FlammableBlockRegistry.getDefaultInstance().add(BaobabWoodModBlocks.MOD_PLANKS, 20, 5);
        FlammableBlockRegistry.getDefaultInstance().add(BaobabWoodModBlocks.MOD_SLAB, 20, 5);
        FlammableBlockRegistry.getDefaultInstance().add(BaobabWoodModBlocks.MOD_FENCE_GATE, 20, 5);
        FlammableBlockRegistry.getDefaultInstance().add(BaobabWoodModBlocks.MOD_FENCE, 20, 5);
        FlammableBlockRegistry.getDefaultInstance().add(BaobabWoodModBlocks.MOD_STAIRS, 20, 5);
        FlammableBlockRegistry.getDefaultInstance().add(BaobabWoodModBlocks.MOD_LEAVES, 60, 30);
    }
