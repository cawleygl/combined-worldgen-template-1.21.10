...
public class WillowTrunkPlacer extends TrunkPlacer {
    ...
    public static final MapCodec<WillowTrunkPlacer> CODEC = RecordCodecBuilder.mapCodec(
            instance -> fillTrunkPlacerFields(instance)
                    .<IntProvider, IntProvider, IntProvider, IntProvider, IntProvider>and(
                            instance.group(
                                    IntProvider.POSITIVE_CODEC.fieldOf("lower_diverge_point").forGetter((WillowTrunkPlacer trunkPlacer) -> trunkPlacer.lowerDivergePoint),
                                    IntProvider.POSITIVE_CODEC.fieldOf("upper_diverge_point").forGetter((WillowTrunkPlacer trunkPlacer) -> trunkPlacer.upperDivergePoint),
                                    IntProvider.POSITIVE_CODEC.fieldOf("lower_branch_steps").forGetter((WillowTrunkPlacer trunkPlacer) -> trunkPlacer.lowerBranchSteps),
                                    IntProvider.POSITIVE_CODEC.fieldOf("lower_number_of_branches").forGetter((WillowTrunkPlacer trunkPlacer) -> trunkPlacer.lowerNumberOfBranches),
                                    IntProvider.POSITIVE_CODEC.fieldOf("upper_number_of_branches").forGetter((WillowTrunkPlacer trunkPlacer) -> trunkPlacer.upperNumberOfBranches)
                            )
                    )
    ...
    protected TrunkPlacerType<?> getType() {
        return ModTreeBuilders.WILLOW_TRUNK_PLACER;
    }
