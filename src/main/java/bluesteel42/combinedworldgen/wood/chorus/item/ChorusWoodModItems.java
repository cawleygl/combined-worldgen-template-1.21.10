package bluesteel42.combinedworldgen.wood.chorus.item;
...
public class ChorusWoodModItems {
    public static final Item MOD_SIGN = registerSignItem(ChorusWoodInitializer.MOD_WOOD_NAME + "_sign");
    public static final Item MOD_HANGING_SIGN = registerHangingSignItem(ChorusWoodInitializer.MOD_WOOD_NAME + "_hanging_sign");
    ...
    public static void initialize() {
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.FUNCTIONAL)
                .register((itemGroup) -> {
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ChorusWoodModItems.MOD_HANGING_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ChorusWoodModItems.MOD_SIGN);
                });
