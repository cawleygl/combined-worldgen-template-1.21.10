...
public class SnowyPineSaplingBlock extends PlantBlock implements Fertilizable {
    public static final MapCodec<SnowyPineSaplingBlock> CODEC = RecordCodecBuilder.mapCodec(
            instance -> instance.group(SaplingGenerator.CODEC.fieldOf("tree").forGetter(block -> block.generator), createSettingsCodec())
                    .apply(instance, SnowyPineSaplingBlock::new)
    );
    ...
    @Override
    public MapCodec<? extends SnowyPineSaplingBlock> getCodec() {
        return CODEC;
    }

    public SnowyPineSaplingBlock(SaplingGenerator generator, AbstractBlock.Settings settings) {
        super(settings);
    ...
    public static BlockState getMeltedState() {
        return PineWoodModBlocks.MOD_SAPLING.getDefaultState();
    }
