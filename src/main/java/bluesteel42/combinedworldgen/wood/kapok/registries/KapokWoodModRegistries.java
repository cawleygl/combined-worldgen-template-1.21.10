...
//        CompostingChanceRegistry.INSTANCE.add(KapokWoodModBlocks.MOD_SAPLING, 0.3F);
    ...
    public static void registerFlammables() {
        ...
        FlammableBlockRegistry.getDefaultInstance().add(KapokWoodModBlocks.MOD_PLANKS, 20, 5);
        FlammableBlockRegistry.getDefaultInstance().add(KapokWoodModBlocks.MOD_SLAB, 20, 5);
        FlammableBlockRegistry.getDefaultInstance().add(KapokWoodModBlocks.MOD_FENCE_GATE, 20, 5);
        FlammableBlockRegistry.getDefaultInstance().add(KapokWoodModBlocks.MOD_FENCE, 20, 5);
        FlammableBlockRegistry.getDefaultInstance().add(KapokWoodModBlocks.MOD_STAIRS, 20, 5);
        FlammableBlockRegistry.getDefaultInstance().add(KapokWoodModBlocks.MOD_LEAVES, 60, 30);
    }
