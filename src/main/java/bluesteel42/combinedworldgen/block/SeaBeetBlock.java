...
public class SeaBeetBlock extends PlantBlock implements Fertilizable {
    public static final MapCodec<SeaBeetBlock> CODEC = createCodec(SeaBeetBlock::new);
    private static final VoxelShape SHAPE = Block.createColumnShape(12.0, 0.0, 5.0);

    @Override
    public MapCodec<SeaBeetBlock> getCodec() {
        return CODEC;
    }

    public SeaBeetBlock(Settings settings) {
        super(settings);
    }
